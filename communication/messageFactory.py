...
class MessageFactory:
    ...
    def newRTSRMessage(robotName, robotStatus, x, y, theta, speed, battery, loading):
        ...
        byteBuffer.appendInt(int(speed))
    ...
    def newPalletizerReleasingFinish(palletizerID, node):
        byteBuffer = ByteBuffer()
        byteBuffer.appendInt(40000)
        byteBuffer.appendInt(MessageType.PalletizerReleasingFinish.value, signed=False)
        byteBuffer.appendInt(20)
        byteBuffer.appendInt(palletizerID.value)
        byteBuffer.appendInt(node)
        return byteBuffer.toBytes()
    ...
    def newAckPalletizerStartMessage(service, byteBuffer):
        print('     [Ack]', MessageType.AckPalletizerStart.name, service.palletizerID.name)
    ...
    def newAckEndPalletizerStartMessage(service, byteBuffer):
        print('     [AckEnd]', MessageType.AckEndPalletizerStart.name, service.palletizerID.name, service.result.value)
    ...
    def newAckPalletizerStopMessage(service, byteBuffer):
        print('     [Ack]', MessageType.AckPalletizerStop.name, service.palletizerID.name)
    ...
    def newAckEndPalletizerStopMessage(service, byteBuffer):
        print('     [AckEnd]', MessageType.AckEndPalletizerStop.name, service.palletizerID.name, service.result.value)
